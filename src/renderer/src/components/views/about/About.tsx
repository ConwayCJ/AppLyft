    ...
    <div className="hero min-h-screen">
      <div className="hero-content bg-base-300 text-left h-full">
        <div className="max-w-xl  text-base-content p-6 rounded">
          ...
          <a className="link link-info mx-2" href="https://www.linkedin.com/in/conwaycj/" target="_blank" rel="noreferrer">
            Chris
          </a>
          &
          <a className="link link-info mx-2" href="https://www.linkedin.com/in/brycerpinkerton/" target="_blank" rel="noreferrer">
            Bryce
          </a>
          ...
          <div className="flex w-full">
            <a className="link link-hover btn btn-success" href="https://forms.gle/oLGfsoSFg95rLjrG9" target="_blank" rel="noreferrer">
              Leave Feedback
            </a>
          </div>
        </div>
