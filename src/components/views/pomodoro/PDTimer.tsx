...
export default function PDTimer() {
  ...
  const dateObj = new Date(profile.timeLeft.time * 1000);
  ...
  return (
    <div className="stat">
      ...
      <div className={`stat-value ${profile.timeLeft.time > 0 ? 'text-success' : 'text-warning'} w-[100px]`}>{timeString}</div>
      <div className="stat-figure">
        {
          profile.timeLeft.time > 0 ?
